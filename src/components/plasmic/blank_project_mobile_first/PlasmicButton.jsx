...
import sty from "./PlasmicButton.module.css"; // plasmic-import: pCdDmYaj73Q/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: sv2b0scVJAK/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: FOswI6mv2u1/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__l6W7J)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon2Icon
                className={classNames(projectcss.all, sty.svg__p3S18)}
                role={"img"}
              />
            ),
