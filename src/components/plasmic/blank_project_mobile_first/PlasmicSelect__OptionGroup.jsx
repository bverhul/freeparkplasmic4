...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: uOplMSPNnBi/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: 774l4u5epK4/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__bbWsQ)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__sBgp)}
              />
            </React.Fragment>
          ),
