...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: Ke6UH1Zxj-7/component
import Select__Option from "../../Select__Option"; // plasmic-import: iuYUgHhXtPO/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: 774l4u5epK4/css
import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: 8BSl9jc4D9_/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: EFhB4V88YJF/icon
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option__g2LFi)}
            value={"value1"}
          >
            {"Option 1"}
          </Select__Option>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option__o6Z9Q)}
            value={"value2"}
          >
            {"Option 2"}
          </Select__Option>
